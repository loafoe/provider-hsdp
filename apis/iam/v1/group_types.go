...
type GroupParameters struct {
	...
	// RoleIDs are the GUIDs of the Roles assigned to this group.
	// +optional
	...
	// RoleRefs reference the Roles assigned to this group.
	// +optional
	RoleRefs []xpv1.NamespacedReference `json:"roleRefs,omitempty"`
