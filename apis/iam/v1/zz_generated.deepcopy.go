...
func (in *GroupObservation) DeepCopyInto(out *GroupObservation) {
	*out = *in
	...
	if in.AssignedUserIDs != nil {
		in, out := &in.AssignedUserIDs, &out.AssignedUserIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AssignedServiceIDs != nil {
		in, out := &in.AssignedServiceIDs, &out.AssignedServiceIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AssignedDeviceIDs != nil {
		in, out := &in.AssignedDeviceIDs, &out.AssignedDeviceIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *RoleObservation) DeepCopyInto(out *RoleObservation) {
	*out = *in
	...
	if in.SharingPolicies != nil {
		in, out := &in.SharingPolicies, &out.SharingPolicies
		*out = make([]RoleSharingPolicyStatus, len(*in))
		copy(*out, *in)
	}
}
...
func (in *RoleParameters) DeepCopyInto(out *RoleParameters) {
	*out = *in
	...
	if in.SharingPolicies != nil {
		in, out := &in.SharingPolicies, &out.SharingPolicies
		*out = make([]RoleSharingPolicyParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RoleSharingPolicyParameters) DeepCopyInto(out *RoleSharingPolicyParameters) {
	*out = *in
	...
	if in.TargetOrganizationRef != nil {
		in, out := &in.TargetOrganizationRef, &out.TargetOrganizationRef
		*out = new(v2.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetOrganizationSelector != nil {
		in, out := &in.TargetOrganizationSelector, &out.TargetOrganizationSelector
		*out = new(v2.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Purpose != nil {
