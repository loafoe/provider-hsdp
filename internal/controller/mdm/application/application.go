...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(mdmv1.ApplicationGroupKind)
	...
	r := managed.NewReconciler(mgr, resource.ManagedKind(mdmv1.ApplicationGroupVersionKind), opts...)

	return ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o.ForControllerRuntime()).
		WithEventFilter(resource.DesiredStateChanged()).
		For(&mdmv1.Application{}).
...
func (e *external) isUpToDate(cr *mdmv1.Application, app *mdm.Application) bool {
